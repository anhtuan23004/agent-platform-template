...
scripts/bin/harness-cli work-item ... # Add or update spec/epic/story/spike/task tree items
...
scripts/bin/harness-cli work-item add ...
scripts/bin/harness-cli work-item update ...
...
```bash
curl -fsSL "https://raw.githubusercontent.com/anhtuan23004/spec-kit-harness/main/scripts/install-harness.sh?$(date +%s)" | bash -s -- --yes
```

```powershell
& ([scriptblock]::Create((irm "https://raw.githubusercontent.com/anhtuan23004/spec-kit-harness/main/scripts/install-harness.ps1"))) -Yes
```

```bash
curl -fsSL "https://raw.githubusercontent.com/anhtuan23004/spec-kit-harness/main/scripts/install-harness.sh?$(date +%s)" | bash -s -- --merge --yes
```

```powershell
& ([scriptblock]::Create((irm "https://raw.githubusercontent.com/anhtuan23004/spec-kit-harness/main/scripts/install-harness.ps1"))) -Merge -Yes
```

```bash
curl -fsSL "https://raw.githubusercontent.com/anhtuan23004/spec-kit-harness/main/scripts/install-harness.sh?$(date +%s)" | bash -s -- --merge --refresh-agent-shim --yes
```

```powershell
& ([scriptblock]::Create((irm "https://raw.githubusercontent.com/anhtuan23004/spec-kit-harness/main/scripts/install-harness.ps1"))) -Merge -RefreshAgentShim -Yes
```
