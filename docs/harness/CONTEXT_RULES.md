...
| `docs/architecture/ARCHITECTURE.md` | Skip | Should for code or boundary changes | Must |
...
| `docs/harness/IMPROVEMENT_PROTOCOL.md` | Skip | Should for Harness improvements | Must if changing improvement flow |
...
| `docs/architecture/ARCHITECTURE.md` | Skip | Should for structural changes | Must |
...
| Task changes trace quality or observability rules | Read `docs/harness/TRACE_SPEC.md`, `docs/harness/HARNESS_AUDIT.md`, and `docs/harness/IMPROVEMENT_PROTOCOL.md`. |
...
| High-risk | About 10K tokens of Harness context | Full intake, architecture, relevant decisions, high-risk templates, product docs, validation docs, and trace spec when Harness behavior changes. | High-risk work needs source hierarchy, prior decisions, and proof expectations in context before implementation. |
